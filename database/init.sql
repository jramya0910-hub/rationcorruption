-- ============================================================
-- Smart Ration Guardian — Supabase / PostgreSQL Init Script
-- Run this in Supabase → SQL Editor → New Query → Run
-- ============================================================

-- Enable UUID extension (already enabled on Supabase, safe to repeat)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ============================================================
-- ENUMS
-- ============================================================
DO $$ BEGIN CREATE TYPE grain_type_enum      AS ENUM ('RICE','WHEAT','SUGAR','OIL');           EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE risk_level_enum      AS ENUM ('LOW','MEDIUM','HIGH');                   EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE complaint_type_enum  AS ENUM ('UNDERWEIGHT','POOR_QUALITY','OVERCHARGING','NOT_AVAILABLE','OTHER'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE complaint_status_enum AS ENUM ('OPEN','UNDER_REVIEW','RESOLVED');       EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- NOTE: Supabase doesn't support GENERATED ALWAYS AS STORED for
--       expressions referencing other columns in older PG versions;
--       remaining_stock_kg is computed in the application layer.
-- ============================================================
...
--   Beneficiaries / Officers : ben123
--   Shopkeepers              : shop123
--   Officer                  : officer123
-- ============================================================

-- Shops
INSERT INTO shops (shop_id, shop_name, owner_name, location, district, risk_score, risk_level, password_hash)
VALUES
  ('a1b2c3d4-0001-0001-0001-000000000001','Ravi Ration Shop',   'Ravi Kumar',   '12, Gandhi Nagar, Chennai',    'Chennai',    35.0,'LOW',    '$2b$12$pWbYWj8Ixj9rV34DXbDQaucVgY7psNstXA36qOA8HHQbdje4wFfk.'),
  ('a1b2c3d4-0002-0002-0002-000000000002','Lakshmi Stores',     'Lakshmi Devi', '45, Nehru Street, Coimbatore', 'Coimbatore', 62.5,'MEDIUM', '$2b$12$pWbYWj8Ixj9rV34DXbDQaucVgY7psNstXA36qOA8HHQbdje4wFfk.'),
  ('a1b2c3d4-0003-0003-0003-000000000003','Murugan Fair Price', 'Murugan S',    '7, Anna Road, Madurai',        'Madurai',    80.2,'HIGH',   '$2b$12$pWbYWj8Ixj9rV34DXbDQaucVgY7psNstXA36qOA8HHQbdje4wFfk.')
ON CONFLICT (shop_id) DO NOTHING;

-- Beneficiaries  (password: ben123)
INSERT INTO beneficiaries (beneficiary_id, ration_card_number, name, phone, address, family_members, assigned_shop_id, monthly_entitlement_kg, password_hash)
VALUES
  ('b0000001-0000-0000-0000-000000000001','TN-CHN-001001','Arun Selvam',    '9876543201','3, Rose Street, Chennai',       4,'a1b2c3d4-0001-0001-0001-000000000001',20.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000002','TN-CHN-001002','Priya Rajan',    '9876543202','7, Lotus Avenue, Chennai',       3,'a1b2c3d4-0001-0001-0001-000000000001',15.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000003','TN-CHN-001003','Suresh Babu',    '9876543203','21, MG Road, Chennai',           5,'a1b2c3d4-0001-0001-0001-000000000001',25.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000004','TN-CBE-002001','Meena Krishnan', '9876543204','8, Sundar Nagar, Coimbatore',    2,'a1b2c3d4-0002-0002-0002-000000000002',10.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000005','TN-CBE-002002','Vijay Anand',    '9876543205','14, Bharathi St, Coimbatore',    6,'a1b2c3d4-0002-0002-0002-000000000002',30.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000006','TN-CBE-002003','Kavitha Sundar', '9876543206','2, Park Road, Coimbatore',       3,'a1b2c3d4-0002-0002-0002-000000000002',15.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000007','TN-MDU-003001','Raja Pandian',   '9876543207','5, Temple Street, Madurai',      4,'a1b2c3d4-0003-0003-0003-000000000003',20.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000008','TN-MDU-003002','Saranya Devi',   '9876543208','9, West Veli St, Madurai',       5,'a1b2c3d4-0003-0003-0003-000000000003',25.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000009','TN-MDU-003003','Mani Kumar',     '9876543209','33, East Veli St, Madurai',      2,'a1b2c3d4-0003-0003-0003-000000000003',10.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS'),
  ('b0000001-0000-0000-0000-000000000010','TN-MDU-003004','Devi Lakshmanan','9876543210','11, Kochadai, Madurai',          7,'a1b2c3d4-0003-0003-0003-000000000003',35.0,'$2b$12$GCU7SQsU0IkFQB4tclkOqucMa2NHPwceskm7juAoPkN6A8EE4UHFS')
...
INSERT INTO complaints (beneficiary_id, shop_id, complaint_type, description, status, ai_category) VALUES
  ...
  ('b0000001-0000-0000-0000-000000000005','a1b2c3d4-0002-0002-0002-000000000002','NOT_AVAILABLE','Shop was closed for 3 days during distribution window.','RESOLVED','NOT_AVAILABLE'),
  ('b0000001-0000-0000-0000-000000000009','a1b2c3d4-0003-0003-0003-000000000003','UNDERWEIGHT',  'Sugar quantity given was less. Only 400g instead of 1 kg.','OPEN','UNDERWEIGHT');

-- Fraud Alerts
INSERT INTO fraud_alerts (shop_id, alert_type, description, severity, is_reviewed) VALUES
  ('a1b2c3d4-0002-0002-0002-000000000002','STOCK_MISMATCH', 'Distributed stock (580 kg) nearly equals received (600 kg) with very low QR verification rate. Possible ghost transactions.','HIGH',FALSE),
  ('a1b2c3d4-0003-0003-0003-000000000003','LOW_DISTRIBUTION','Only 300 kg out of 700 kg received rice distributed. Possible diversion to black market.','CRITICAL',FALSE);
...
INSERT INTO officers (name, email, district, password_hash) VALUES
  ('District Officer Ramesh','officer@tnration.gov.in','Chennai','$2b$12$aEpTtVBTjjNTVIoF..8dtu4nYlqF7H5D0O4m7trOhh.ogb6/Lpj9q')
